...
export default function MeilleurHammamMarrakechPage() {
  ...
  const jsonLd = {
    ...
    "@type": "ItemList",
    name: "Meilleur Hammam à Marrakech",
    description: "Les meilleurs hammams de Marrakech : bains publics traditionnels et spas de luxe.",
    url: CANONICAL,
  ...
  const faqJsonLd = {
    ...
    "@type": "FAQPage",
    mainEntity: [
      { "@type": "Question", name: "Quel est le meilleur hammam de Marrakech ?", acceptedAnswer: { "@type": "Answer", text: "Hammam de la Rose pour une expérience raffinée, Hammam Mouassine pour l'authenticité, et le spa du Royal Mansour pour le luxe absolu." } },
      { "@type": "Question", name: "Combien coûte un hammam à Marrakech ?", acceptedAnswer: { "@type": "Answer", text: "Hammam public : 20–50 DH. Hammam touristique : 150–300 DH. Spa de luxe : 500–2000 DH." } },
      { "@type": "Question", name: "Que faut-il apporter au hammam ?", acceptedAnswer: { "@type": "Answer", text: "Des tongs et un maillot de bain. Le savon noir, le gant de gommage et les serviettes sont généralement fournis." } },
    ],
  };
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Meilleur Hammam", item: CANONICAL },
    ],
  };
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl p-8 mb-10 shadow-sm border border-slate-100">
            <p className="text-slate-700 text-lg leading-relaxed mb-4">
              Le hammam est bien plus qu&apos;un bain — c&apos;est un rituel social ancestral. &Agrave; Marrakech, l&apos;exp&eacute;rience va du hammam de quartier o&ugrave; les locaux se retrouvent au spa palatial o&ugrave; chaque d&eacute;tail est pens&eacute;. Les deux m&eacute;ritent le d&eacute;tour.
            </p>
            <p className="text-slate-600 leading-relaxed">
              {filteredPlaces.length} hammams test&eacute;s — des bains publics aux retraites de luxe.
            </p>
          </div>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-6" style={{ fontFamily: "var(--font-playfair)" }}>
            Les meilleurs hammams de Marrakech ({filteredPlaces.length} adresses)
          </h2>
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-8 mb-10">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex gap-3"><span className="text-amber-500 flex-shrink-0">&rarr;</span>Les hammams traditionnels ont des horaires s&eacute;par&eacute;s hommes/femmes — v&eacute;rifiez avant d&apos;y aller.</li>
              <li className="flex gap-3"><span className="text-amber-500 flex-shrink-0">&rarr;</span>Apportez vos tongs. Le savon noir et le gant de gommage sont g&eacute;n&eacute;ralement fournis.</li>
              <li className="flex gap-3"><span className="text-amber-500 flex-shrink-0">&rarr;</span>R&eacute;servez les soins de luxe 24 &agrave; 48h &agrave; l&apos;avance, surtout en haute saison (octobre–avril).</li>
              <li className="flex gap-3"><span className="text-amber-500 flex-shrink-0">&rarr;</span>Pr&eacute;voyez un pourboire de 20 &agrave; 50 DH pour le personnel du hammam.</li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 mb-10 shadow-sm border border-slate-100">
            ...
            <div className="space-y-6">
              {[
                { q: "Quel est le meilleur hammam de Marrakech ?", a: "Hammam de la Rose pour une expérience raffinée, Hammam Mouassine pour l'authenticité, et le spa du Royal Mansour pour le luxe absolu." },
                { q: "Combien coûte un hammam à Marrakech ?", a: "Hammam public : 20–50 DH. Hammam touristique : 150–300 DH. Spa de luxe : 500–2000 DH." },
                { q: "Que faut-il apporter au hammam ?", a: "Des tongs et un maillot de bain. Le savon noir, le gant de gommage et les serviettes sont généralement fournis." },
              ].map((item) => (
                <div key={item.q}>
