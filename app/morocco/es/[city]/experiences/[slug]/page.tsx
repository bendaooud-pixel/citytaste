...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `${BASE}/morocco/es/${citySlug}/experiences/${slug}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        it: `${BASE}/morocco/it/${citySlug}/experiences/${slug}`,
      },
    },
    openGraph: {
      title,
...
export default async function MoroccoExperienceEsPage({ params }: Props) {
  const { city: citySlug, slug } = await params;
